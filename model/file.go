...
type Files struct {
	...
	TypeId         uint             `json:"type_id" gorm:"column:type_id;not null;default:0;comment:分类id"`                           //分类id 0 图片 2其他 3证件 4APK
	CloudType      consts.CloudType `json:"cloud_type" gorm:"column:cloud_type;not null;default:0;comment:云类型"`                      //云类型
	FileType       consts.FileType  `json:"file_type" gorm:"column:file_type;not null;default:0;comment:文件类型"`                       //文件类型,0 未知，1 图片，2 JSON
	...
	Uid            uint             `json:"uid" gorm:"column:uid;not null;default:0;comment:用户id"`                                   //用户id
	Bid            uint             `json:"bid" gorm:"column:bid;not null;default:0;comment:分区id"`                                   //分区id
	...
	TempExist      bool             `json:"temp_exist" gorm:"column:temp_exist;not null;default:0;comment:临时文件是否存在"`                 // 临时文件是否存在
...
type FilesTemp struct {
	FileId uint   `json:"file_id" gorm:"not null;default:0;comment:源文件id"`               //源文件id
