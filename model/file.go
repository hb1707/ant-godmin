...
const (
	FileSourceKindUploaded       FileSourceKind = "uploaded"
	FileSourceKindPreviewCapture FileSourceKind = "preview_capture"
	FileSourceKindAIGenerated    FileSourceKind = "ai_generated"
...
type FilesTemp struct {
	FileId uint   `json:"file_id" gorm:"not null;default:0;comment:源文件id;type:integer"`  //源文件id
