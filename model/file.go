...
type Files struct {
	...
	Cover     string           `json:"cover" gorm:"type:varchar(255) not null;default:'';comment:封面"`                     //封面
	Status    FileStatus       `json:"state" gorm:"type:tinyint UNSIGNED not null;default:0;comment:文件状态"`              //文件状态
